...
class CompactCmd : public BaseCmd {
 public:
  CompactCmd(const std::string& name, int16_t arity);
...
class CompactRangeCmd : public BaseCmd {
 public:
  CompactRangeCmd(const std::string& name, int16_t arity);
